...
<body>
            ...
            <div>
                <ul id="navbar">
                    ...
                    <ul id="new" style="display: none;">
                            ...
                            <li> <i class="fas fa-shopping-cart"></i>   <a href="order.html">My Orders</a> </li>
	...
	<section class="py-5 my-5">
		<div class="container">
			<h1 class="mb-5">Update Account</h1>
				...
				<div class="profile-tab-nav border-right">
					...
					<div class="p-4">
						<div class="img-circle text-center mb-3">
							...
							<input type="file" id="profile-picture" accept="image/*"> <img src="imgs/user2.jpeg" alt="Image" class="shadow" id="profile-image">
							<span class="file-input-icon"> </span>
							<span class="file-input-label">  </span>
							</label> 
						<div>
							<button class="btn btn-primary">Save</button>
							<button class="btn btn-light">Cancel</button> <hr>
						</div>
						</div>
