...
if (isset($_POST['action']) && isset($_POST['id'])) {
    ...
    if ($action === 'decline') {
        $sql = "UPDATE cashier SET STA_TUS = 'deactive' WHERE ID = $id";

        if ($conn->query($sql) === TRUE) {
            echo "<script>alert('Record delated successfully');</script>";
        }
    } elseif ($action === 'approve') {
        $sql = "UPDATE cashier SET STA_TUS = 'active' WHERE ID = $id";
            ...
            <div class="MainChartM">
                ...
                <div class="ChartM">
                    ...
                    <h1>Cashier Information</h1> 
                        <div class="CardM">
                            <a href="addcashier.php"><button style="background:none;"><span style="color:#088178; hover:black; font-size:18px;"> Add New Cashier </span></button> <i class="fas fa-user" style="color:black;"></i> </a>
                   ...
                   <table id="tableM">
                    ...
                    while ($row = mysqli_fetch_array($run)) {
                        ...
                        <form class='manager-form' method='POST'>
                            ...
                            <td>
                            <form action='cashier.php' method='POST' style='border: none;' onsubmit=\"return confirm('Are you sure you want to deactivate this cashier?')\">
                        ...
                        <td>
                            <form action='cashier.php' method='POST' style='border: none;' onsubmit=\"return confirm('Are you sure you want to activate this cashier?')\">
                                <input type='hidden' name='id' value='$id'>
