    ...
    <div class="container">
       ...
       ?>
        ...
        <?php include "sidebar.php"?>
                  ...
                  $sql = "SELECT * FROM items WHERE (EXPIRE_DATE > CURDATE() AND EXPIRE_DATE <= DATE_ADD(CURDATE(), INTERVAL 2 MONTH)) OR (QUANTITY <= 5 AND EXPIRE_DATE > CURDATE())";
                  $res = $conn->query($sql);

                       
                        if($res->num_rows >0){
                          echo "<div class='MainChart2 table1'>
                          <div class='Chart2'>
                             <h1>Low  Quantity or Expired Soon Products</h1> <br>
                             <div>  ";
