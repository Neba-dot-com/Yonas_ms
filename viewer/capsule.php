...
<nav class="navbar">
  ...
  <a href="login.php">Login</a>    
        ...
        <!-- This is where Banner Starts -->
<section style="background-image:url('img/banner/s4.jpg');border: none; background-repeat: norepeat; background-position:fit;"> <br>

        <!-- This is where Search Bar Starts -->

        <div class="search" style="margin-top: 30px; margin-left: 150px;"> 
            <form class="search-bar"  style="border-bottom: none; border-left: none; border-right: none;">
                ...
                <button type="submit" style="  border: 0;border-radius: 50%;width: 20px;height: 60px; background-image: none; "> <img src="img/search.png" style="width: 45px; position: relative; top: 30%; right: 40px; transform: translateY(-50%);  border-radius: 25px;"> </button>
              </form>    
            </div>
                     <br> <h2>CAPSULES...</h2> 
</section>
         <!-- This is where Banner Ends -->

         <!-- This is where Product Shelf Starts -->         
<section id="product1" class="section-p1">
         <h3  style="background-color: #088178; font-size: 25px;"><i>#Powerful Capsules, <b style="color: #fff;">Empowering Pharmacies! </b></h3></i> 
        
        <!-- The Big Div Starts-->
        <div class="pro-container">
        <!-- The Div That Will Loop Itself Starts-->  
            <div class="pro">
                <a href="login.html"><img src="img/Capsule/c1.jpg" alt="">
                <div class="des">
                 ...
                 <i class="fal fa-shopping-cart cart fa-2x" style="border: none;"></i>
            </div> </a>
        <!-- The Div That Will Loop Itself Ends-->

    <!-- Div 2-->
             <div class="pro">
             <a href="login.html">   <img src="img/Capsule/c2.jpg" alt=""> 
                <div class="des">
                ...
                <i class="fal fa-shopping-cart cart fa-2x" style="border: none;"></i></a>
            </div>
    <!-- Div 3-->
             <div class="pro">
             <a href="login.html">   <img src="img/Capsule/c3.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 4-->
             <div class="pro">
              <a href="login.html">  <img src="img/Capsule/c4.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 5-->
            <div class="pro">
           <a href="login.html"> <img src="img/Capsule/c5.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 6-->        
             <div class="pro">
          <a href="login.html"> <img src="img/Capsule/c6.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 7-->        
             <div class="pro">
        <a href="login.html"> <img src="img/Capsule/c7.jpg" alt="">
                <div class="des">
                    <span>Heparins</span>
                    <h5>Enoxaparin</h5>
                    <div class="star">
    ...
    <!-- Div 8-->        
             <div class="pro">
          <a href="login.html"> <img src="img/Capsule/c8.jpg" alt="">
                <div class="des">
        ...
        </div> <!-- The Big Div Ends-->   
    </section> 
                <!-- Pagination Starts--> 
    <section id="pagination" class="section-p1">
         <a href="capsule.html">1</a>
         <a href="#">2</a>
...
<section class="footer">
    <div class="box-container">
        <div class="box">
            ...
            <a href="vabout.html"> <i class="fas fa-chevron-right"></i> about us </a>
            <a href="vcontact.html"> <i class="fas fa-chevron-right"></i> contact us </a>
        ...
        <div class="box">
            <h3>our services</h3>
            <a href="#"> <i class="fas fa-chevron-right"></i> Online Shoping </a>
            <a href="#"> <i class="fas fa-chevron-right"></i> Online Payment </a>
            <a href="#"> <i class="fas fa-chevron-right"></i> Delivery </a>
