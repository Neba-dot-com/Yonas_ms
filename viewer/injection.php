...
<section style="background-image:url('img/banner/s4.jpg');border: none; background-repeat: norepeat; background-position:fit;"> 
               <br> <br> <br> <br>
...
<section id="product1" class="section-p1">
        <h3 style="font-size: 25px; background-color: #088178;"><i>#Inject savings into your pharmacy:  <b style="color: #fff;">Discounted injections at your fingertips! </b></h3></i>   
            
            <!-- The Big Div Starts-->
        <div class="pro-container">
            <!-- The Div That Will Loop Itself Starts-->
            <div class="pro">
                <a href="login.html"><img src="img/injection/ia.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 2-->
             <div class="pro">
             <a href="login.html">   <img src="img/injection/i2.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 3-->
             <div class="pro">
             <a href="login.html">   <img src="img/injection/i3.jpg" alt=""> </a>
                <div class="des">
    ...
    <!-- Div 4-->
             <div class="pro">
              <a href="login.html">  <img src="img/injection/i4.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 5-->        
             <div class="pro">
           <a href="login.html">   <img src="img/injection/i5.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 6-->        
             <div class="pro">
          <a href="login.html"><img src="img/injection/i6.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 7-->        
             <div class="pro">
        <a href="login.html"><img src="img/injection/i7.jpg" alt="">
                <div class="des">
                    <span>Heparins</span>
                    <h5>Enoxaparin</h5>
                    <div class="star">
    ...
    <!-- Div 8-->
             <div class="pro">
          <a href="login.html"><img src="img/injection/i8.jpg" alt="">
                <div class="des">
...
<!--  This is where Sign up and Login Button Div Starts -->
