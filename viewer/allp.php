...
<section id="product1" class="section-p1">
         <h3  style="background-color: #088178; font-size: 25px;"><i>#Powerful Tablets, <b style="color: #fff;">Empowering Pharmacies! </b></h3></i> 
        
        <!-- The Big Div Starts-->
        <div class="pro-container">
        <!-- The Div That Will Loop Itself Starts-->  
            <div class="pro">
                <a href="login.html"><img src="img/Tablet/t1.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 2-->
             <div class="pro">
             <a href="login.html">   <img src="img/Tablet/t2b.jpg" alt=""> 
                <div class="des">
    ...
    <!-- Div 3-->
             <div class="pro">
             <a href="login.html">   <img src="img/Tablet/t3.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 4-->
             <div class="pro">
              <a href="login.html">  <img src="img/Tablet/t4c.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 5-->
            <div class="pro">
           <a href="login.html"> <img src="img/Tablet/t5.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 6-->        
             <div class="pro">
          <a href="login.html"> <img src="img/Tablet/t6.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 7-->        
             <div class="pro">
        <a href="login.html"> <img src="img/Tablet/t7.jpg" alt="">
                <div class="des">
                    <span>Heparins</span>
                    <h5>Enoxaparin</h5>
                    <div class="star">
    ...
    <!-- Div 8-->        
             <div class="pro">
          <a href="login.html"> <img src="img/Tablet/t8.jpg" alt="">
                <div class="des">
