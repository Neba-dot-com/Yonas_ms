...
<section id="product1" class="section-p1">
         <h3 style="font-size: 25px; background-color: #088178;"><i>#Elevate your pharmacy with discounted  <b style="color: #fff;">skin care solutions! </b></h3></i>  
            <!-- The Big Div Starts-->
        <div class="pro-container">
            <!-- The Div That Will Loop Itself Starts--> 
            <div class="pro">
                <a href="login.html"><img src="img/Skin/s1.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 2-->
            <div class="pro">
             <a href="login.html">   <img src="img/Skin/s2.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 3-->
             <div class="pro">
             <a href="login.html">   <img src="img/Skin/s3.jpg" alt=""> </a>
                <div class="des">
    ...
    <!-- Div 4-->
             <div class="pro">
              <a href="login.html">  <img src="img/Skin/s4.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 5-->        
             <div class="pro">
           <a href="login.html">   <img src="img/Skin/s5.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 6-->        
             <div class="pro">
          <a href="login.html"><img src="img/Skin/s6.jpg" alt="">
                <div class="des">
    ...
    <!-- Div 7-->        
             <div class="pro">
        <a href="login.html"><img src="img/Skin/s7.jpg" alt="">
                <div class="des">
                    <span>Heparins</span>
                    <h5>Enoxaparin</h5>
                    <div class="star">
    ...
    <!-- Div 8-->
             <div class="pro">
          <a href="login.html"><img src="img/Skin/s8.jpg" alt="">
                <div class="des">
